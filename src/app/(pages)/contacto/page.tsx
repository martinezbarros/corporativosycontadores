...
export const metadata: Metadata = {
  ...
  description: 'Contacte al Bufete de Abogados Corporativos y Contadores. Oficinas en Panamá. Soluciones integrales legales y contables para su empresa.',
  keywords: ["contacto abogados", "oficinas panamá", "consultoría empresarial", "asesoría fiscal corporativa", "ubicación bufete", "soporte integral"]
};
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Oceanía Business Plaza, Torre 1000, C. Isaac Hanono Missri, Panamá</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">+507 6613-4375</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">abogadosprotecciondeactivos@gmail.com</p>
                      </div>
                    </div>
