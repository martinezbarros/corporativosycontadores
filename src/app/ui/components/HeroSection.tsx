...
export default function HeroSection({pageTitle} : {pageTitle: string}) {
    return(
        <section
            ...
            style={{ backgroundImage: "url('https://bakerandalvarez.site/bufetedeabogadoscorporativosycontadores/wp-content/uploads/sites/4/2025/09/panama-dark-scaled.jpg')", backgroundPosition:"center center", backgroundSize:"cover" }} // coloca tu imagen en /public
        >
